...
export default function NavBtnLeft(props) {
  ...
  return (
    ...
    sx={{
      ...
      <CommonNavBtn dyn_Color= {"#FFC294"} dyn_Width={"110px"} dyn_height={"110px"} 
                    dyn_btnText={"کاروبر"}  
                    dyn_Value={"/Business_Entery"} 
                    FlexD={"column-reverse"}
                    dyn_endIcons={<BusinessIcon/>}  />
      <CommonNavBtn dyn_Color= {"#89CAFF"} dyn_Width={"110px"} dyn_height={"110px"} 
                    dyn_btnText={"کاریگر"}  
                    dyn_Value={"/Expert_Entery"} 
                    FlexD={"column-reverse"}
                    dyn_endIcons={<EngineeringIcon/>}  />

      <CommonNavBtn dyn_Color= {"#588539"} dyn_Width={"110px"} dyn_height={"110px"} 
                    dyn_btnText={"مزدورہیلپر"}  
                    dyn_Value={"/Helper_Entry"} 
                    FlexD={"column-reverse"}
                    dyn_endIcons={<HomeRepairServiceIcon/>}  />

      <CommonNavBtn dyn_Color= {"#AFBBCB"} dyn_Width={"110px"} dyn_height={"110px"} 
                    dyn_btnText={"گھریلوسامان"}  
                    dyn_Value={""} 
                    FlexD={"column-reverse"}
                    dyn_endIcons={<GiBlockHouse/>}  />

      <CommonNavBtn dyn_Color= {"#FFC106"} dyn_Width={"110px"} dyn_height={"110px"} 
                    dyn_btnText={"مالمویشی"}  
                    dyn_Value={""} 
                    FlexD={"column-reverse"}
                    dyn_endIcons={<SiHappycow/>}  />

      <CommonNavBtn dyn_Color= {"#06B354"} dyn_Width={"110px"} dyn_height={"110px"} 
      ...
      <CommonNavBtn dyn_Color= {"#C70F0F"} dyn_Width={"110px"} dyn_height={"110px"} 
